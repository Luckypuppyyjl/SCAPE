...
class TransformerPoseDataset(TransformerBaseDataset):
    ...
    def make_paired_samples(self):
        ...
        for cls in self.valid_class_ids:
            for _ in range(self.num_episodes):
                shots = random.sample(self.cat2obj[cls], self.num_shots + 1)
    ...
    def _load_coco_keypoint_annotation_kernel(self, img_id):
        ...
        for obj in objs:
            ...
            rec.append({
                ...
                'bbox_id': self.obj_id,
                'flip':False,
                'pair':cata_pair[str(category_id)] if str(category_id) in cata_pair else None
            })
            bbox_id = bbox_id + 1
            self.obj_id += 1
    ...
    def evaluate(self, outputs, metric='PCK', **kwargs):
        ...
        """
        res_folder='/data/yjliang/code/Category-Agnostic-Pose-Estimation/P2/Pose-for-Everything/work_dirs/ab_token_3_bs16_spilt1_MAE_PVT1_initMAE_single_0.1_shot1_loss_12/'
