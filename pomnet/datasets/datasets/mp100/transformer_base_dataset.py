                    ...
                    for kid, kpt in enumerate(kpts):
                        ...
                        if mask[kid]==True:
                            ...
                            cv2.addWeighted(
                                ...
                                0,
                                dst=img)
                    #out_file = '/data/yjliang/code/Category-Agnostic-Pose-Estimation/P2/Pose-for-Everything/work_dirs/token_3_bs16_spilt1_MAE_PVT1_initMAE_single_0.1/tu2/' + out_dir_lei + '/'
                    out_file ='/data/yjliang/code/Category-Agnostic-Pose-Estimation/P2/Pose-for-Everything/work_dirs/TEST_VIS/gt/'+ out_dir_lei + '/'
    ...
    def _report_metric(self,
        ...
        if 'PCK' in metrics:
            ...
            for (output, gt, mask, thr_bbox,lei,file_name) in zip(outputs, gts, masks, threshold_bbox,lei_list,file_name_list):
                ...
                pck_.append(pck)
                pck_avg.append(pck)
                output1={'keypoints':gt,'bbox':np.zeros(4)}
                ...
                result[13] = [0,0,0]
                result[14] = [139, 34, 82]
                result[15] = [139, 102, 139]
                result[16] = [191, 62, 255]
                result[17] = [255, 225, 255]
                result[18] = [28, 28, 28]
                result[19] = [0, 0, 139]
                result[20] = [144, 238, 144]
                result[21] = [0, 139, 139]
                result[22] = [30, 144, 255]
                result[23] = [193, 205, 205]
                result[24] = [255, 228, 196]
                result[25] = [250, 128, 114]
                result[26] = [107, 142, 35]
                result[27] = [46, 139, 87]
                result[28] = [224, 255, 255]
                result[29] = [176, 196, 222]
                result[30] = [70, 130, 180]
                result[31] = [123, 104, 238]
                result[32] = [0, 0, 128]
                result[33] = [255, 228, 225]
                result[34] = [240, 255, 255]
                result[35] = [255, 228, 196]
                result[36] = [0, 0, 0]
                result[37] = [105, 105, 105]
                result[38] = [112, 128, 144]
                result[39] = [0, 191, 255]
                result[40] = [187, 255, 255]
                result[41] = [187, 255, 255]
                result[42] = [187, 255, 255]
                result[43] = [187, 255, 255]
                result[44] = [187, 255, 255]

                color = [result]


                #self.show_result(file_name,[output1],pck,mask=mask,pose_kpt_color_list=color,out_dir_lei=lei,out_file_=file_name.split('/')[3])
