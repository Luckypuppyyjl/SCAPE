...
data = dict(
    ...
    train=dict(
        type='TransformerPoseDataset',
         ann_file=f'{data_root}/cross_category_annotations/fewshot_train_furniture.json',
    ...
    val=dict(
        type='TransformerPoseDataset',
        ann_file=f'{data_root}/cross_category_annotations/fewshot_test_furniture.json',
        img_prefix=f'{data_root}/',
        data_cfg=data_cfg,
        valid_class_ids=None,
        max_kpt_num=channel_cfg['max_kpt_num'],
